# Prevendo a Probabilidade de Conversão do Lead

# Pergunta: Qual o número provável de usuários convertidos? (Regressão)
# Pergunta: Um Lead será convertido? Sim ou Não? Qual a probabilidade? (Classificação)



setwd("~/DataScienceStructure/LinguagemR/Cap11")
getwd()
...
# Carregando os dados
dados_dsa <- read.csv("Classificacao/dataset.csv")
...
# Fazer o balanceamento de clase para verificar o resultado final 
